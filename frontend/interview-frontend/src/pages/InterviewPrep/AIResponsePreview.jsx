...
const AIResponsePreview = ({content})=>{
    ...
    return(
        <div className="max-w-4xl mx-auto bg-gray-300/50">
            <div className="text-[14px] text-black prose prose-slate dark:prose-invert max-w-none">
            <ReactMarkdown
  ...
  td({ children }) {
    return <td className="px-3 py-2 text-sm text-sm">{children}</td>;
  },
  hr(){
    ...
    return <>
     <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-300">
        ...
        >
         {copied ? (
          <LuCheck size={16} className="text-grenen-600" />
         ) : (
          <LuCopy size={16} />
         )} 
        {copied && (
